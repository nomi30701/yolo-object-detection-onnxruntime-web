 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hh;function h2(){return hh||(hh=1,function(e){function r(q,J){var Q=q.length;q.push(J);e:for(;0<Q;){var z=Q-1>>>1,N=q[z];if(0<o(N,J))q[z]=J,q[Q]=N,Q=z;else break e}}function i(q){return q.length===0?null:q[0]}function s(q){if(q.length===0)return null;var J=q[0],Q=q.pop();if(Q!==J){q[0]=Q;e:for(var z=0,N=q.length,ne=N>>>1;z<ne;){var ce=2*(z+1)-1,xe=q[ce],Ce=ce+1,je=q[Ce];if(0>o(xe,Q))Ce<N&&0>o(je,xe)?(q[z]=je,q[Ce]=Q,z=Ce):(q[z]=xe,q[ce]=Q,z=ce);else if(Ce<N&&0>o(je,Q))q[z]=je,q[Ce]=Q,z=Ce;else break e}}return J}function o(q,J){var Q=q.sortIndex-J.sortIndex;return Q!==0?Q:q.id-J.id}if(typeof performance=="object"&&typeof performance.now=="function"){var d=performance;e.unstable_now=function(){return d.now()}}else{var u=Date,h=u.now();e.unstable_now=function(){return u.now()-h}}var m=[],g=[],_=1,v=null,f=3,x=!1,S=!1,b=!1,T=typeof setTimeout=="function"?setTimeout:null,A=typeof clearTimeout=="function"?clearTimeout:null,C=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function O(q){for(var J=i(g);J!==null;){if(J.callback===null)s(g);else if(J.startTime<=q)s(g),J.sortIndex=J.expirationTime,r(m,J);else break;J=i(g)}}function R(q){if(b=!1,O(q),!S)if(i(m)!==null)S=!0,ve(B);else{var J=i(g);J!==null&&ke(R,J.startTime-q)}}function B(q,J){S=!1,b&&(b=!1,A(Y),Y=-1),x=!0;var Q=f;try{for(O(J),v=i(m);v!==null&&(!(v.expirationTime>J)||q&&!me());){var z=v.callback;if(typeof z=="function"){v.callback=null,f=v.priorityLevel;var N=z(v.expirationTime<=J);J=e.unstable_now(),typeof N=="function"?v.callback=N:v===i(m)&&s(m),O(J)}else s(m);v=i(m)}if(v!==null)var ne=!0;else{var ce=i(g);ce!==null&&ke(R,ce.startTime-J),ne=!1}return ne}finally{v=null,f=Q,x=!1}}var F=!1,U=null,Y=-1,ae=5,oe=-1;function me(){return!(e.unstable_now()-oe<ae)}function ge(){if(U!==null){var q=e.unstable_now();oe=q;var J=!0;try{J=U(!0,q)}finally{J?le():(F=!1,U=null)}}else F=!1}var le;if(typeof C=="function")le=function(){C(ge)};else if(typeof MessageChannel<"u"){var Te=new MessageChannel,Oe=Te.port2;Te.port1.onmessage=ge,le=function(){Oe.postMessage(null)}}else le=function(){T(ge,0)};function ve(q){U=q,F||(F=!0,le())}function ke(q,J){Y=T(function(){q(e.unstable_now())},J)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(q){q.callback=null},e.unstable_continueExecution=function(){S||x||(S=!0,ve(B))},e.unstable_forceFrameRate=function(q){0>q||125<q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ae=0<q?Math.floor(1e3/q):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return i(m)},e.unstable_next=function(q){switch(f){case 1:case 2:case 3:var J=3;break;default:J=f}var Q=f;f=J;try{return q()}finally{f=Q}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(q,J){switch(q){case 1:case 2:case 3:case 4:case 5:break;default:q=3}var Q=f;f=q;try{return J()}finally{f=Q}},e.unstable_scheduleCallback=function(q,J,Q){var z=e.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?z+Q:z):Q=z,q){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=Q+N,q={id:_++,callback:J,priorityLevel:q,startTime:Q,expirationTime:N,sortIndex:-1},Q>z?(q.sortIndex=Q,r(g,q),i(m)===null&&q===i(g)&&(b?(A(Y),Y=-1):b=!0,ke(R,Q-z))):(q.sortIndex=N,r(m,q),S||x||(S=!0,ve(B))),q},e.unstable_shouldYield=me,e.unstable_wrapCallback=function(q){var J=f;return function(){var Q=f;f=J;try{return q.apply(this,arguments)}finally{f=Q}}}}(jd)),jd}var mh;function m2(){return mh||(mh=1,Ud.exports=h2()),Ud.exports}/**
 * @license React
  ...
  ${A.mainStart()}
    ...
    ${S.setByOffset("global_idx",x.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:r,getShaderSource:S=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:d,dataType:o}],dispatchGroup:{x:m},programUniforms:[{type:12,data:g}]})}},zn=(e,r,i,s)=>{let o=e.inputs.length===1?i:Mc(e.inputs,i),d=o.axes;d.length===0&&!o.noopWithEmptyAxes&&(d=e.inputs[0].dims.map((x,S)=>S));let u=K.normalizeAxes(d,e.inputs[0].dims.length),h=u,m=e.inputs[0],g=em(h,e.inputs[0].dims.length);g.length>0&&(m=e.compute(ln(e.inputs[0],g),{inputs:[0],outputs:[-1]})[0],h=Yh(h.length,m.dims.length));let[_,v]=Zh(m.dims,h),f=_;o.keepDims&&(f=Xh(_,u)),e.compute(tm(r,{hint:o.cacheKey,inputDependencies:["type"]},[m],s,e.inputs[0].dataType,f,v),{inputs:[m]})},E0=(e,r)=>{zn(e,"ReduceMeanShared",r,"mean")},C0=(e,r)=>{zn(e,"ReduceL1Shared",r,"l1")},T0=(e,r)=>{zn(e,"ReduceL2Shared",r,"l2")},I0=(e,r)=>{zn(e,"ReduceLogSumExpShared",r,"logSumExp")},z0=(e,r)=>{zn(e,"ReduceMaxShared",r,"max")},A0=(e,r)=>{zn(e,"ReduceMinShared",r,"min")},R0=(e,r)=>{zn(e,"ReduceProdShared",r,"prod")},O0=(e,r)=>{zn(e,"ReduceSumShared",r,"sum")},P0=(e,r)=>{zn(e,"ReduceSumSquareShared",r,"sumSquare")},B0=(e,r)=>{zn(e,"ReduceLogSumShared",r,"logSum")}}),An,nm,Ju,Mc,Rn,rm,im,am,sm,om,um,lm,dm,cm,fm,On,M0,D0,N0,L0,U0,j0,F0,W0,V0,H0,cf=re(()=>{Ae(),Be(),gt(),Me(),G2(),An=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},nm=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ju=(e,r,i,s,o,d,u=!1,h=!1)=>{let m=[],g=i[0].dims,_=g.length,v=K.normalizeAxes(o,_),f=!h&&v.length===0;g.forEach((b,T)=>{f||v.indexOf(T)>=0?u&&m.push(1):m.push(b)});let x=m.length,S=K.size(m);return{name:e,shaderCache:r,getShaderSource:b=>{let T=[],A=Z("_A",i[0].dataType,_),C=be("output",d,x),O=s(A,C,v),R=O[2];for(let B=0,F=0;B<_;B++)f||v.indexOf(B)>=0?(u&&F++,R=`for(var j${B}: u32 = 0; j${B} < ${g[B]}; j${B}++) {
...
var best_index : i32 = 0;`,`if (${s.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:i,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:h,programUniforms:g}),getShaderSource:_},{inputs:m,outputs:[-1,-1,-1]})},K0=(e,r)=>{let i=pm(e.inputs,r),[s,o,d]=ym(e,i);return eo(e,s,o,d,e.inputs[4],void 0,void 0,void 0,e.inputs[5],i,r)}}),wm,vm,_m,Q0,Q2=re(()=>{Mn(),Ae(),Be(),gt(),Me(),wm=(e,r)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let i=(s,o,d)=>{let u=o.length;if(u!==s.length)throw new Error(`${d}: num dimensions != ${u}`);o.forEach((h,m)=>{if(h!==s[m])throw new Error(`${d}: dim[${m}] do not match`)})};if(e[0].dims.length>1){let s=r.format==="NHWC"?r.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,r.spatial?2:void 0);i(e[1].dims,s,"Invalid input scale"),i(e[2].dims,s,"Invalid input B"),i(e[3].dims,s,"Invalid input mean"),i(e[4].dims,s,"Invalid input var")}else i(e[1].dims,[1],"Invalid input scale"),i(e[2].dims,[1],"Invalid input B"),i(e[3].dims,[1],"Invalid input mean"),i(e[4].dims,[1],"Invalid input var")},vm=(e,r)=>{let{epsilon:i,spatial:s,format:o}=r,d=e[0].dims,u=s?pt(d[d.length-1]):1,h=o==="NHWC"&&d.length>1?u:1,m=K.size(d)/u,g=s,_=g?d.length:d,v=Z("x",e[0].dataType,e[0].dims,u),f=Z("scale",e[1].dataType,e[1].dims,h),x=Z("bias",e[2].dataType,e[2].dims,h),S=Z("inputMean",e[3].dataType,e[3].dims,h),b=Z("inputVar",e[4].dataType,e[4].dims,h),T=be("y",e[0].dataType,_,u),A=()=>{let O="";if(s)O=`let cOffset = ${d.length===1?"0u":o==="NHWC"?`outputIndices[${d.length-1}] / ${u}`:"outputIndices[1]"};`;else if(o==="NCHW")O=`
...
bIndices[${C-2}] = u32(row);
  ...
  ${b?el(T,A,ve,Oe):tl(T,A,ve,Oe)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${B}) {
      ...
      }`,z=Z("x",e[0].dataType,e[0].dims.length,B===3?1:B),N=Z("w",e[1].dataType,e[1].dims.length,q),ne=[z,N],ce=be("result",e[0].dataType,i.length,q);if(u){let xe=Z("bias",e[2].dataType,e[2].dims.length,q);ne.push(xe),Q+=`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${r.cacheKey};${d};${u};${f};${g[0]};${g[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:v}),getShaderSource:x}}}),Uc,Wm,Zw,Xw=re(()=>{Ae(),Be(),sl(),Me(),Yr(),Uc=(e,r,i,s,o=!1,d)=>{let u=e[0].dims,h=e[1].dims,m=u[u.length-2],g=h[h.length-1],_=u[u.length-1],v=pt(g),f=pt(_),x=pt(m),S=K.size(i)/v/x,b=e.length>2,T=s?s.slice(0,-2):i.slice(0,-2),A=[K.size(T),m,g],C=[{type:12,data:S},{type:12,data:m},{type:12,data:g},{type:12,data:_}];Gr(r,C),C.push(...he(T,u,h)),b&&C.push(...he(e[2].dims)),C.push(...he(A));let O=R=>{let B=df("batch_dims",e[0].dataType,T.length),F=Z("a",e[0].dataType,u.length,f),U=Z("b",e[1].dataType,h.length,v),Y=be("output",e[0].dataType,A.length,v),ae=vt(Y.type.tensor),oe=qr(r,Y.type.value,ae),me=[F,U],ge="";if(b){let Q=o?v:1;me.push(Z("bias",e[2].dataType,e[2].dims.length,Q)),ge=`${o?`value += bias[col / ${Q}];`:`value += ${Y.type.value}(bias[row + i]);`}`}let le=u.slice(0,-2),Te=h.slice(0,-2),Oe=Js(le,T),ve=Js(Te,T),ke=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Kr(r,ke);let q=(Q,z)=>{let N=Q.rank,ne=Q.name;if(N===2)return`var ${ne}_indices = ${Q.type.indices}(0u, 0u);`;let ce=B.rank,xe=`var ${ne}_indices: ${Q.type.indices};`;for(let Ce=N-2-1,je=ce-1;Ce>=0;Ce--,je--)xe+=`
${ne}_indices[${Ce}] = ${ce>1?`batch_indices[${je}]`:"batch_indices"};`;return z.forEach(Ce=>{xe+=`
${ne}_indices[${Ce}] = 0;`}),xe+=`${ne}_indices[${N-2}] = 0u;
                     ${ne}_indices[${N-1}] = 0u;`,xe},J=()=>{let Q=`var a_data: ${F.type.value};`;for(let z=0;z<f;z++)Q+=`
              let b_data${z} = b[(b_offset + (k + ${z}) * uniforms.N + col) / ${v}];`;for(let z=0;z<x;z++){Q+=`a_data = a[(a_offset + (row + ${z}) * uniforms.K + k) / ${f}];`;for(let N=0;N<f;N++)Q+=`
            values[${z}] = fma(${U.type.value}(a_data${f===1?"":`[${N}]`}), b_data${N}, values[${z}]);
`}return Q};return`
  ${R.registerUniforms(ke).registerInternalVariables(B).declareVariables(...me,Y)}
  ${R.mainStart()}
...
`)};
    ...
    ${f}`},m=[{type:12,data:u},...he(r,s)];return{name:"Expand",shaderCache:{hint:`${s.length}`,inputDependencies:["rank"]},getShaderSource:h,getRunData:()=>({outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:m})}},uv=e=>{fg(e.inputs),e.compute(hg(e.inputs),{inputs:[0]})}}),mg,lv,c_=re(()=>{Ae(),Be(),Me(),pf(),mg=e=>{let r=e[0].dataType,i=K.size(e[0].dims),s=K.size(e[1].dims),o=s%4===0,d=u=>{let h=Z("x",r,[1],4),m=Z("bias",r,[1],4),g=be("y",r,[1],4),_=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],v=x=>`
    ...
    ${u.mainStart(Ra)}
      ...
      ${f.mainStart()}
        ...
        ${C.setByOffset("global_idx","dequantized_data")};
                     ...
                     indices input tensors be of same rank.`)},$g=(e,r)=>{let i=e[0].dims,s=e[0].dataType,o=i.length,d=e[1].dims,u=e[1].dataType,h=K.normalizeAxis(r.axis,o),m=i[h],g=d.slice(0),_=K.size(g),v=Z("input",s,o),f=Z("indicesInput",u,d.length),x=be("output",s,g.length),S=[{type:12,data:_},{type:6,data:m},{type:12,data:h}];return S.push(...he(i,d,g)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:g,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:S}),getShaderSource:b=>`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${m};${h}`,inputDependencies:S},getRunData:()=>({outputs:[{dims:x,dataType:1}],dispatchGroup:{x:v},programUniforms:b}),getShaderSource:T},{inputs:[r,i,s],outputs:[-1]})[0]},zg=(e,r,i)=>{let s=r[0].dims,o=s,d=2,u=s[0],h=s[1],m=K.sizeFromDimension(s,d),g=pt(m),_=K.size(o)/g,v=mc(e,r[0],r[1],r[2],u,m,h,i.epsilon),f=[u,h,m/g],x=[u,h],S=["type","none"],b=T=>{let A=Z("x",r[0].dataType,f.length,g),C=Z("scale_shift",1,x.length,2),O=be("output",r[0].dataType,f.length,g),R=[A,C,O];return`
  ...
  ${B.mainStart()}
    ...
    ${C?"inv_std_output[global_idx] = inv_std_dev":""};
          ...
          `;for(let N=0;N<x*b;N++)z+=`
            ...
            b_quantized_values = ${ke}(${Array.from({length:4},(ne,ce)=>`${ve}(b_value_lower[${ce}]), ${ve}(b_value_upper[${ce}])`).join(", ")});
            b_dequantized_values = ${v===1?`${ke}(${Array.from({length:8},(ne,ce)=>`(b_quantized_values[${ce}] - ${le?`zero_point${N}`:"zero_point"}) * scale${N}`).join(", ")});`:`(b_quantized_values - ${ke}(${Array(8).fill(`${le?`zero_point${N}`:"zero_point"}`).join(",")})) * scale${N};`};
          ...
          `;return z},J=()=>{let z=`
            ...
            col_index += 1;`;return z},Q=()=>{let z=`col_index = col * ${x};`;for(let N=0;N<x*b;N++)z+=`
            ...
            var b_dequantized_values: ${ke};`,z};return`
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${r.blockSize};${r.bits};${v};${f};${x};${b};${A}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:S,dataType:_}],dispatchGroup:{x:T},programUniforms:C}),getShaderSource:F}},Mg=(e,r)=>{let i=e[0].dims,s=i.length,o=i[s-2],d=r.k,u=r.n,h=i.slice(0,s-2),m=K.size(h),g=e[1].dims[2]/4,_=e[0].dataType,v=pt(r.k),f=pt(g),x=h.concat([o,u]),S=128,b=u%8===0?8:u%4===0?4:1,T=S/b,A=T*f*8,C=A/v,O=A/r.blockSize,R=K.size(x)/b,B=[],F=[m,o,d/v],U=K.convertShape(e[1].dims).slice();U.splice(-1,1,g/f),B.push(...he(F)),B.push(...he(U)),B.push(...he(e[2].dims)),e.length===4&&B.push(...he(K.convertShape(e[3].dims)));let Y=[m,o,u];B.push(...he(Y));let ae=oe=>{let me=F.length,ge=Z("a",e[0].dataType,me,v),le=Z("b",12,U.length,f),Te=Z("scales",e[2].dataType,e[2].dims.length),Oe=[ge,le,Te],ve=e.length===4?Z("zero_points",12,e[3].dims.length):void 0;ve&&Oe.push(ve);let ke=Y.length,q=be("output",e[0].dataType,ke),J=vt(e[0].dataType),Q=()=>{switch(v){case 1:return`
...
`:"",uy=(e,r,i,s,o)=>{let[d,u,h,m]=i.length===2?[-1,0,1,-1]:[0,2,3,1],g=e.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${r.type.indices}) -> ${x} {
    ...
    }`},cy=(e,r,i,s,o,d)=>{let u=e.dims,h=ny(d,r.axes,u.length),m=ry(u,s,o,r.axes),g=s.slice();s.length===0&&(g=u.map((C,O)=>C===0?1:m[O]/C),r.keepAspectRatioPolicy!=="stretch"&&(m=iy(u,g,r)));let _=be("output",e.dataType,m.length),v=Z("input",e.dataType,u.length),f=K.size(m),x=u.length===m.length&&u.every((C,O)=>C===m[O]),S=r.coordinateTransformMode==="tf_crop_and_resize",b=r.extrapolationValue,T=v.type.value,A=C=>`
      ${x?"":`
...
`}
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:Ze({interleaved:i}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:b,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(K.size(f)/Ra)},programUniforms:S})}},Vv=(e,r)=>{py(e.inputs,r),e.compute(hy(e.inputs,r))}}),my,gy,Hv,E_=re(()=>{Ae(),Be(),Me(),my=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let r=e[0],i=e[1],s=e[2];if(r.dataType!==i.dataType||r.dataType!==s.dataType)throw new Error("All inputs must have the same data type");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Input must be 2D or 3D");if(i.dims.length!==3&&i.dims.length!==2)throw new Error("Skip must be 2D or 3D");let o=r.dims[r.dims.length-1],d=r.dims[r.dims.length-2];if(i.dims[i.dims.length-1]!==o)throw new Error("Skip must have the same hidden size as input");if(i.dims[i.dims.length-2]!==d)throw new Error("Skip must have the same sequence length as input");if(s.dims.length!==1)throw new Error("Gamma must be 1D");if(s.dims[s.dims.length-1]!==o)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let u=e[3];if(u.dims.length!==1)throw new Error("Beta must be 1D");if(u.dims[u.dims.length-1]!==o)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let u=e[4];if(u.dims.length!==1)throw new Error("Bias must be 1D");if(u.dims[u.dims.length-1]!==o)throw new Error("Bias must have the same hidden size as input")}},gy=(e,r,i,s)=>{let o=r.simplified,d=e[0].dims,u=K.size(d),h=d,m=u,g=d.slice(-1)[0],_=s?d.slice(0,-1).concat(1):[],v=!o&&e.length>3,f=e.length>4,x=s&&i>1,S=s&&i>2,b=i>3,T=64,A=pt(g),C=[{type:12,data:m},{type:12,data:A},{type:12,data:g},{type:1,data:r.epsilon}],O=B=>{let F=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],U=[Z("x",e[0].dataType,e[0].dims,A),Z("skip",e[1].dataType,e[1].dims,A),Z("gamma",e[2].dataType,e[2].dims,A)];v&&U.push(Z("beta",e[3].dataType,e[3].dims,A)),f&&U.push(Z("bias",e[4].dataType,e[4].dims,A)),U.push(be("output",e[0].dataType,h,A)),x&&U.push(be("mean_output",1,_)),S&&U.push(be("inv_std_output",1,_)),b&&U.push(be("input_skip_bias_sum",e[0].dataType,h,A));let Y=vt(e[0].dataType),ae=vt(1,A);return`
      ...
      ${B.mainStart([T,1,1])}
        ...
        for (var i: u32 = 0; i < stride; i++) {
          ...
          return input_indices;
      }`,_y=(e,r)=>{let i=e[0].dims,s=K.size(i),o=r.axes.length>0?K.normalizeAxes(r.axes,i.length):[...Array(i.length).keys()],d=Ws(e,4);d.forEach(A=>A!==0||(()=>{throw new Error("step cannot be 0")})),d.length===0&&(d=Array(o.length).fill(1));let u=r.starts.map((A,C)=>kc(A,C,i,o,d)),h=r.ends.map((A,C)=>kc(A,C,i,o,d));if(o.length!==u.length||o.length!==h.length)throw new Error("start, ends and axes should have the same number of elements");if(o.length!==i.length)for(let A=0;A<i.length;++A)o.includes(A)||(u.splice(A,0,0),h.splice(A,0,i[A]),d.splice(A,0,1));let m=d.map(A=>Math.sign(A));d.forEach((A,C,O)=>{if(A<0){let R=(h[C]-u[C])/A,B=u[C],F=B+R*d[C];u[C]=F,h[C]=B,O[C]=-A}});let g=i.slice(0);o.forEach((A,C)=>{g[A]=Math.ceil((h[A]-u[A])/d[A])});let _={dims:g,dataType:e[0].dataType},v=be("output",e[0].dataType,g.length),f=Z("input",e[0].dataType,e[0].dims.length),x=K.size(g),S=[{name:"outputSize",type:"u32"},{name:"starts",type:"u32",length:u.length},{name:"signs",type:"i32",length:m.length},{name:"steps",type:"u32",length:d.length}],b=[{type:12,data:x},{type:12,data:u},{type:6,data:m},{type:12,data:d},...he(e[0].dims,g)],T=A=>`
